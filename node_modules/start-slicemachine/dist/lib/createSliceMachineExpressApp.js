...
import { setUser } from './../_node_modules/@sentry/core/esm/exports.js';
const createSliceMachineExpressApp = async (args) => {
  ...
  if (process.env.NODE_ENV === "development") {
    ...
    app.get("/:lib/:sliceID/:variation", (_req, res) => {
      res.sendFile(path.join(sliceMachineOutDir, "[lib]/[sliceName]/[variation].html"));
    });
    app.get("/:lib/:sliceID/:variation/simulator", (_req, res) => {
      res.sendFile(path.join(sliceMachineOutDir, "[lib]/[sliceName]/[variation]/simulator.html"));
    });
    app.get("/:lib/:sliceID/:variation/screenshot", (_req, res) => {
      res.sendFile(path.join(sliceMachineOutDir, "[lib]/[sliceName]/[variation]/screenshot.html"));
    });
  }
